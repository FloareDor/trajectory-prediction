...
i made this to learn how to make a trajectory prediction model to estimate the future paths of vehicles, pedestrians, and cyclists in autonomous-driving scenarios. i also wanted to see if nearby agents and road-map data help us and, if so, by how much. the model sees 5 seconds of motion and predicts the next 6.
